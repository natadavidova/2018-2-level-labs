...
### Шаг 4.3 Реализация предсказания предложения по заданному префиксу
...
Так как для генерации текста необходимо иметь отправную точку, например, для би-грамм это
первое слово, для три-грамм - первые два слова, то мы передаем этот префикс - список
